...
[{assign var="backurl" value=$oViewConf->getSelfLink()|cat:"cl=basket&fnc=backtoshop" }]
...
<table class="basket-total product_notice" cellspacing="0" width="100%">
	...
	[{if $oxcmp_basket->getDelCostNet() }]
	      <tr class="sumrow">
	        ...
	        <td class="price" id="test_basketDeliveryNet" align="right">[{ $oxcmp_basket->getDelCostNet() }]&nbsp;[{ $currency->sign }]</td>
	      </tr>
	  [{/if}]
	    [{if $oxcmp_basket->getDelCostVat() }]
	      <tr class="sumrow">
	        <td class="sumdesc">[{ oxmultilang ident="BASKET_PLUSTAX1" }] [{ $oxcmp_basket->getDelCostVatPercent() }][{ oxmultilang ident="BASKET_PLUSTAX2" }]</td>
	        <td class="price" id="test_basketDeliveryVAT" align="right">[{ $oxcmp_basket->getDelCostVat() }]&nbsp;[{ $currency->sign }]</td>
	      </tr>
	    [{/if }]
	
	    [{if $oxcmp_basket->getPaymentCosts() }]
	      <tr class="sumrow">
	        <td class="sumdesc">[{if $oxcmp_basket->getPaymentCosts() >= 0}][{ oxmultilang ident="BASKET_PAYMENT" }][{else}][{ oxmultilang ident="BASKET_CHARGE2" }][{/if}] [{ oxmultilang ident="BASKET_DISCOUNT3" }]</td>
	        <td class="price" id="test_basketPaymentNet" align="right">[{ $oxcmp_basket->getPayCostNet() }]&nbsp;[{ $currency->sign }]</td>
	      </tr>
	      [{if $oxcmp_basket->getPayCostVat() }]
	        <tr class="sumrow">
	          <td class="sumdesc">[{ oxmultilang ident="BASKET_PAYMENTTAX1" }][{ $oxcmp_basket->getPayCostVatPercent() }][{ oxmultilang ident="BASKET_PAYMENTTAX2" }]</td>
	          <td class="price" id="test_basketPaymentVAT" align="right">[{ $oxcmp_basket->getPayCostVat() }]&nbsp;[{ $currency->sign }]</td>
	        </tr>
	      [{/if }]
	    [{/if }]
