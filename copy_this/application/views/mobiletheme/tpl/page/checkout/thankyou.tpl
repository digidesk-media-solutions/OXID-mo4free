...
<div id="content">
[{include file="_titlesection.tpl" header="THANKYOU_TITLE"|oxmultilangassign back=$oViewConf->getHomeLink()}]
<div class="contMain">
...
[{assign var="basket" value=$oView->getBasket()}]
  ...
  <div class="box info"><strong class="boxhead">[{ oxmultilang ident="THANKYOU_PREVIOUSORDER" }]</strong></div>
  <div class="box info">
  ...
  <div class="box info"><strong class="boxhead">[{ oxmultilang ident="TS_RATINGS" }]</strong></div>
  <div class="box info">
    <div>
  ...
  <div class="box info"><strong class="boxhead">[{ oxmultilang ident="THANKYOU_PARTNERFROM" }]</strong></div>
  <div class="box info">
      <div>
